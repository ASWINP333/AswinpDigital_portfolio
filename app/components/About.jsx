    ...
    >
      ...
      >
        <div className="flex flex-col lg:flex-row justify-between gap-2 lg:gap-0">
          ...
          >
            I’m a passionate{" "}
            <strong>Digital Marketing Expert in Malappuram</strong> and
            <strong> Full Stack Web Developer (MERN)</strong> with 1 year of
            hands-on experience building responsive websites and implementing
            result-driven digital marketing strategies. I blend creative design,
            modern web technologies, and data-backed marketing to help
            businesses grow their online presence, attract the right audience,
            and achieve measurable results. My goal is to deliver digital
            solutions that are visually appealing, SEO-friendly, and aligned
              ...
              {toolsData.map((tool, idx) => (
                <li key={idx} className="w-12 sm:w-14 aspect-square">
                  ...
                  >
                    <Image
                      src={tool}
                      alt={`Digital Marketing Expert in Malappuram | Web Developer Tools ${
                        idx + 1
                      }`}
                      width={36}
                      height={36}
