...
const Services = () => {
  return (
    ...
    >
      ...
      >
        Services — Digital Marketing Expert in Malappuram
      </motion.h1>
      <motion.h4
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
      ...
      >
        I’m a passionate <b>Digital Marketing Expert in Malappuram</b> and
        <b>Full Stack Web Developer (MERN Stack).</b> I build responsive,
        SEO-optimized, and conversion-focused websites while combining creative
        design, data-driven marketing, and modern web technologies like
        React.js, Node.js, Express, and MongoDB to help businesses strengthen
      ...
      >
        {serviceData.map(({ icon, title, description, link }, index) => (
          ...
          >
            <Image src={icon} alt={`Digital Marketing Expert in Malappuram | Web Developer ${title} service`} className="w-10" />
